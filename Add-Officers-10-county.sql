...
set @newOfficer_lo_code = '95543' --int
set @newOfficer_name = 'Chris Shires' --nvarchar(50)
set @newOfficer_State = 'Colorado'--nvarchar(50)  --Alabama Arizona California Colorado Florida New Mexico Texas
set @newOfficer_County = 'Denver' --nvarchar(50)
set @newOfficer_County2 = 'Boulder'--nvarchar(50)
set @newOfficer_County3 = 'Adams'--nvarchar(50)
set @newOfficer_County4 = 'Arapahoe'--nvarchar(50)
set @newOfficer_County5 = 'Larimer'--nvarchar(50)
set @newOfficer_County6 = 'Jefferson'--nvarchar(50)
set @newOfficer_County7 = 'Douglas'--nvarchar(50)
set @newOfficer_County8 = 'Pueblo'--nvarchar(50)
set @newOfficer_County9 = 'El Paso'--nvarchar(50)
set @newOfficer_County10 = 'Weld' --nvarchar(50)
set @newOfficer_street_address = '8101 E Belleview Ave- Ste A10, Denver, CO 80237' --nvarchar(max)
set @newOfficer_office_phone_number = '303-713-3367' --nvarchar(50)
set @newOfficer_cell_phone_number = '720-728-9849' --nvarchar(50)
set @newOfficer_fax_number = '205-524-2231' --nvarchar(50)
set @newOfficer_site_effective_date = '7/18/2016' --datetime
set @newOfficer_nmls_originator_id = '989159' --int
set @newOfficer_email_address = 'christopher.shires@bbva.com' --nvarchar(50)
set @newOfficer_main_url = 'https://mortgage.bbvacompass.com/default.asp?siteId=0742AD4F-DC51-445E-A05B-520A5F488C59' --nvarchar(max)
set @newOfficer_alias_url = 'www.bbvacompass.com/mortgages/cshires' --nvarchar(max)
